...
| Runbook | When to use |
| --- | --- |
| [github-airgap.md](github-airgap.md) | **Default.** Edit on Omarchy, push GitHub, operator pulls on the MacBook Pro. No SSH to that laptop. |
| [dev-env-local.md](dev-env-local.md) | Open the Xcode project and run Simulator on a Mac (operator). |
| [omarchy-mac-loop.md](omarchy-mac-loop.md) | Optional dedicated Apple builder only — never the personal laptop. |
...
| [v1-sanity-pass.md](v1-sanity-pass.md) | Simulator sanity, including the pinned RC tag if comparing. |
