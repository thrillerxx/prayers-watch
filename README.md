...
- **Current liked snapshot:** `rosary-liked` (`9bb27c4` on `main`).
- **Liked voice/scripture snapshot:** `rosary-voice-liked` (`dcb8a3c` on `main`).
- **Prior content snapshot:** `rosary-complete-liked` (`631b00f`, before bead indicator).
